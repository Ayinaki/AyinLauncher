...
const supportLink = ref('https://discord.gg/ayin')
const metadata = ref({})
...
defineExpose({
	async show(errorVal, context, canClose = true, source = null) {
		...
		if (errorVal.message && errorVal.message.includes('Minecraft authentication error:')) {
			...
			supportLink.value = 'https://discord.gg/ayin'
			...
			title.value = 'Error initializing Ayin Launcher'
			...
			<div class="markdown-body">
				<template v-if="errorType === 'minecraft_auth'">
					<template v-if="metadata.network">
						...
						<p>
							It looks like there were issues with the Ayin Launcher connecting to Microsoft's
				...
				<template v-if="errorType === 'directory_move'">
					<template v-if="metadata.readOnly">
						...
						<p>
							It looks like the Ayin Launcher is unable to write to the directory you selected.
					...
					<template v-else>
						<p>
							The Ayin Launcher is unable to migrate to the new directory you selected. Please
				...
				<template v-else-if="errorType === 'state_init'">
					<p>
						Ayin Launcher failed to load correctly. This may be because of a corrupted file, or
				...
				<template v-else-if="errorType === 'no_loader_version'">
					<p>The Ayin Launcher failed to find the loader version for this instance.</p>
