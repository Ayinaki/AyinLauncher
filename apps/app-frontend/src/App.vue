...
import { install_create_modpack_instance, install_get_modpack_preview, install_import_curseforge_modpack, install_open_cf_urls, install_scan_folder_for_mods } from '@/helpers/install'
...
async function setupApp() {
	...
	fetch(`https://cdn.ayin.fun/appCriticalAnnouncement_${version}.json`)
...
const updatePopupMessages = defineMessages({
	...
	meteredBody: {
		...
		defaultMessage: `Ayin Launcher v{version} is available now! Since you're on a metered network, we didn't automatically download it.`,
	},
	downloadedBody: {
		id: 'app.update-popup.body.download-complete',
		defaultMessage: `Ayin Launcher v{version} has finished downloading. Reload to update now, or automatically when you close Ayin Launcher.`,
	},
	linuxBody: {
		id: 'app.update-popup.body.linux',
		defaultMessage:
			'Ayin Launcher v{version} is available. Use your package manager to update for the latest features and fixes!',
	},
	reload: {
	...
	>
		...
		<div data-tauri-drag-region class="app-grid-statusbar bg-bg-raised h-[--top-bar-height] flex">
			<div data-tauri-drag-region class="flex min-w-0 flex-1 overflow-hidden p-3">
				<AyinAppLogo class="h-full w-auto shrink-0 text-contrast pointer-events-none" />
	...
	>
		<div class="app-viewport flex-grow router-view">
			<transition name="popup-survey">
				...
				>
					...
					<p class="m-0 leading-tight">
						Would you mind answering a few questions about your experience with Ayin Launcher?
					</p>
					<p class="mt-3 mb-4 leading-tight">
						This feedback will go directly to the Ayin team and help guide future updates!
					</p>
			...
			<div
				...
				class="absolute h-full -z-10 overflow-hidden"
				:style="{
